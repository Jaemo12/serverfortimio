...
// --- Configuration ---
const API_BASE_URL = 'https://serverfortimio-delta.vercel.app/';
const API_ENDPOINTS = {
...
chrome.runtime.onInstalled.addListener(function(details) {
  ...
  // Check if this is a first install and open tutorial
  if (details.reason === 'install') {
    Logger.log('First install detected, opening tutorial');
    chrome.tabs.create({
      url: 'https://timio.news/chrome'
    }).catch(error => {
      Logger.error('Failed to open tutorial tab:', error);
    });
  }
